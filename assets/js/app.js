...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  // jquery__WEBPACK_IMPORTED_MODULE_0___default()(".basemap").click(function (e) {
  //   e.preventDefault();
  //   jquery__WEBPACK_IMPORTED_MODULE_0___default()(".basemap button").toggleClass("hide");
  // });

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".gis").length) {
    var top_bar_height = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".top-bar").outerHeight();
    var window_height = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).outerHeight();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gis').css('height', window_height - top_bar_height);
  }
});
...
module.exports = __webpack_require__(/*! /Users/sungjunghung/project/gis/farmland.prototype/src/assets/js/app.js */"./src/assets/js/app.js");
